...
<head>
    ...
    <title>Your Order Has Been Confirmed by Designer {{$Designer}}</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>The designer will communicate with you via your preferred method, so please keep your channels open.</p>
