@extends('layout.printer-layout')
@vite('resources/css/app.css')

@section('content')
@include('layout.printerdb-layout')
    ...
    <table class="border border-kBlack">
        <thead>
            <tr class="">
                ...
                <td class="p-2 border border-kBlack font-bold">assigned by</td>
            </tr>
        </thead>
        <tbody>
            <tr class="hover:bg-gray-100 cursor-pointer">
                ...
                <td class="p-2 border border-kBlack capitalize"><a href="">designer Jane</a></td>
            </tr>
        </tbody>
    </table>
