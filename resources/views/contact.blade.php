                ...
                <div class="flex flex-col gap-y-3">
                    <div class="flex gap-x-3">
                        <div class="flex flex-col w-[284]">
                            ...
                            <input type="text" class="text-kGray rounded-md focus:outline-none focus:ring-0 focus:border-kBlack" placeholder="Jane Doe">
                        </div>
                        <div class="flex flex-col w-[284]">
                            <h3 class="font-medium text-lg">Subject</h3>
                            <input type="text" class="text-kGray rounded-md focus:outline-none focus:ring-0 focus:border-kBlack" placeholder="Subject name">
                        </div>
                    </div>
                    <div class="flex gap-x-3">
                        <div class="flex flex-col w-[284]">
                        ...
                        <div class="flex flex-col w-[284]">
                            ...
                            <input type="text" class="text-kGray rounded-md focus:outline-none focus:ring-0 focus:border-kBlack" placeholder="Company name">
                        </div>
                    </div>
                    <div class="flex flex-col">
                        <h3 class="font-medium text-lg">Message</h3>
                        <textarea name="" id="" class="text-kGray rounded-md focus:outline-none focus:ring-0 focus:border-kBlack" placeholder="Input message here..."></textarea>
                    </div>
                </div>
