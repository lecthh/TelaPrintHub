...
<h1 class="font-bold text-xl normal-case">Hello, Admin</h1>
<div class="flex flex-col gap-y-3">
    <div class="flex gap-x-3 p-3 bg-kWhite border border-kBlack justify-between">
        <a href="" class="flex flex-grow gap-x-3 p-3 border-r border-kBlack">
            ...
            <div class="flex flex-col gap-y-3">
                <h1 class="text-base font-bold text-[#5C5959]">registered production companies</h1>
                <h1 class="text-xl font-bold">10</h1>
            </div>
        </a>
        <a href="" class="flex flex-grow gap-x-3 p-3 ">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 15.2V9C2 5.5 4 4 7 4H17C20 4 22 5.5 22 9V15C22 18.5 20 20 17 20H8.5" stroke="#171717"
                    stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                <path
            ...
            <div class="flex flex-col gap-y-3">
                <h1 class="text-base font-bold text-[#5C5959]">registered designer</h1>
                <h1 class="text-xl font-bold">6</h1>
            </div>
        </a>
    </div>
    ...
    <div class="flex gap-x-3 p-3 bg-kWhite border border-kBlack justify-between">
        ...
        <a href="" class="flex flex-grow gap-x-3 p-3 border-r border-kBlack">
            ...
            <div class="flex flex-col gap-y-3">
                <h1 class="text-base font-bold text-[#5C5959]">confirmed orders</h1>
                <h1 class="text-xl font-bold">6</h1>
            </div>
        </a>
        <a href="" class="flex flex-grow gap-x-3 p-3 ">
            ...
            <div class="flex flex-col gap-y-3">
                <h1 class="text-base font-bold text-[#5C5959]">pending orders</h1>
                <h1 class="text-xl font-bold">6</h1>
            </div>
        </a>
    </div>
