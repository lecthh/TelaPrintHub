        ...
        <div class="flex flex-col gap-y-3">
            ...
            <div class="flex gap-x-3">
                <label for="tshirt" class="cursor-pointer">
                    <input type="radio" name="apparel" id="tshirt" value="T-shirt" class="hidden peer" {{ request('apparel') === 'T-shirt' ? 'checked' : '' }} onchange="this.form.submit()">
                ...
                <label for="hoodie" class="cursor-pointer">
                    <input type="radio" name="apparel" id="hoodie" value="Hoodie" class="hidden peer" {{ request('apparel') === 'Hoodie' ? 'checked' : '' }} onchange="this.form.submit()">
                ...
                <label for="poloshirt" class="cursor-pointer">
                    <input type="radio" name="apparel" id="poloshirt" value="Polo shirt" class="hidden peer" {{ request('apparel') === 'Polo shirt' ? 'checked' : '' }} onchange="this.form.submit()">
                ...
                <label for="shorts" class="cursor-pointer">
                    <input type="radio" name="apparel" id="shorts" value="Shorts" class="hidden peer" {{ request('apparel') === 'Shorts' ? 'checked' : '' }} onchange="this.form.submit()">
                ...
                <label for="sportswear" class="cursor-pointer">
                    <input type="radio" name="apparel" id="sportswear" value="Sportswear" class="hidden peer" {{ request('apparel') === 'Sportswear' ? 'checked' : '' }} onchange="this.form.submit()">
    ...
    <div class="flex flex-col gap-y-3">
        ...
        <div class="accordion-collapse bg-kLightGray p-3 border-2 border-kBlack rounded-md mb-4" data-accordion="collapse">
            ...
            <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                <div class="pt-4">
                    <p class="text-kBlack mb-2" id="company-description">
