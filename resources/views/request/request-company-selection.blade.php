...
<div class="bg-kWhite px-8 py-10">
    ...
    <form method="POST" action="{{ route('request-company-selection-post') }}" class="flex flex-col gap-y-10">
        ...
        <div class="flex flex-col gap-y-3">
            ...
            <!-- Accordion Section -->
            <div id="companyAccordion" class="accordion-collapse bg-kLightGray p-3 border-2 border-kBlack rounded-md mb-4 hidden">
                <h1 class="" id="accordion-collapse-heading-1">
                    <button type="button"
                        class="bg-kLightGray flex items-center justify-between w-full text-base text-kBlack font-semibold"
                        onclick="toggleAccordion(this)"
                        aria-expanded="false"
                        aria-controls="accordion-collapse-body-1">
                        <span id="company-name">About COMPANY NAME</span>
