...
<div class="bg-kWhite font-dm-sans px-8 py-10 flex gap-x-8 justify-evenly">
    <div class="flex flex-col gap-y-3">
        ...
        <div class="flex flex-col">
            ...
            <input type="text" class="font-normal text-lg text-kGray rounded-md focus:outline-none focus:ring-0 focus:border-kBlack" placeholder="TELAPH-J8tkdg">
        </div>
        <div class="flex flex-col">
            <h3 class="font-medium text-lg">Email address:</h3>
            <input type="email" class="font-normal text-lg text-kGray rounded-md focus:outline-none focus:ring-0 focus:border-kBlack" placeholder="jane@example.com">
        </div>
