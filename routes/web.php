...
Route::get('/request-print-1', [HomeController::class, "requestPrint1"])->name('request-print-1');
Route::get('/request-print-2', [HomeController::class, "requestPrint2"])->name('request-print-2');
Route::get('/request-print-3', [HomeController::class, "requestPrint3"])->name('request-print-3');
